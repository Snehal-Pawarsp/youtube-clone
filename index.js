...
async function display(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=popular%20videos&key=AIzaSyBK6sjTXMRHKLNglLPbrhV5dZ1S4kSYaRI&maxResults=25`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyBK6sjTXMRHKLNglLPbrhV5dZ1S4kSYaRI&maxResults=25`);
let data = await res.json();
